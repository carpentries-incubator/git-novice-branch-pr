...
- One thing may cause confusion is recovering old versions.  If, instead of
  ...
  It's then possible to keep on committing, but things like `git push origin master` a bit later will not give easily comprehensible results.  It also
